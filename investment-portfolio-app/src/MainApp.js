        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold">ArthLaksh</h1>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Settings className="w-6 h-6 text-gray-600 cursor-pointer hover:text-gray-800" />
                <button
                  ...
                  className="flex items-center space-x-2 border border-red-500 text-red-500 px-4 py-2 rounded-md hover:bg-red-50 transition-colors"
                >
                  <span>Logout</span>
                </button>
            </div>
